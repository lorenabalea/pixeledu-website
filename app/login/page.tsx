...
export const metadata: Metadata = {
  title: "Login | Pixel Edu",
  description: "Login to your Pixel Edu account",
}
      ...
      <div className="w-full max-w-md">
        <Card className="light-mode-card border-primary/10">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardDescription>Choose your preferred way to login</CardDescription>
          </CardHeader>
          <CardContent>
            <Tabs defaultValue="email" className="w-full">
              ...
              <TabsContent value="email" className="space-y-4">
                ...
                <div className="space-y-2">
                  <Input type="password" placeholder="Password" className="bg-background/50 border-primary/20" />
                ...
                <Button className="w-full font-heading">Login with Email</Button>
              ...
              <TabsContent value="wallet" className="space-y-4">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Connect your Web3 wallet to access your account and earn $PUR tokens
                  </p>
                </div>
